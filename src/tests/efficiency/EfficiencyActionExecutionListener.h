...
public:
    ...
    SpellInfo(double mana, double castTime, double cooldown, double damage) : mana(mana), castTime(castTime), cooldown(cooldown), damage(damage) {}
